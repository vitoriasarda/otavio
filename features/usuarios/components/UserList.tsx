    ...
    <div className="w-full bg-white rounded-lg p-6 md:p-8">
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        <div className="flex items-center flex-shrink-0">
          {currentPage > 1 && (
            <img
              src="/assets/icone-usuarios.svg"
              alt="Usuários"
              className="w-11 h-12 mr-4 flex-shrink-0"
            />
          )}
          <h2 className={`${currentPage > 1 ? "text-[36px]" : "text-[26px]"} font-medium font-inter text-primary-blue whitespace-nowrap`}>
        ...
        <div className="relative flex items-center w-full md:w-[406px]">
          ...
          <Input
            type="text"
            placeholder="PESQUISAR EM USUÁRIOS CADASTRADOS"
            value={searchTerm}
              ...
              <TableRow key={user.id}>
                ...
                <TableCell>
                  <Button
                    ...
                    className="text-[#0859FF] hover:text-[#0859FF]/80 p-0 mr-4 h-auto text-[14px] font-medium"
                  >
                    EDITAR
                  </Button>
                  <Button
