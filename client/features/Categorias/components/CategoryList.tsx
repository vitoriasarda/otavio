    ...
    <div className="w-full bg-white rounded-lg p-6 md:p-8">
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        <div className="flex items-center flex-shrink-0">
          {currentPage > 1 && (
            <img
              src="/assets/icone-categorias.svg"
              alt="Categorias"
        ...
        <div className="relative flex items-center w-full md:w-[406px]">
          ...
          <Input
            type="text"
            placeholder="PESQUISAR EM CATEGORIAS CADASTRADAS"
            value={searchTerm}
            ...
            {paginatedCategories.map((category) => (
              <TableRow key={category.id}>
                ...
                <TableCell>
                  ...
                  <Button
                    variant="link"
                    className="text-[#FF9C08] hover:text-[#FF9C08]/80 p-0 mr-4 h-auto text-[14px] font-medium"
                  >
                    INATIVAR
                  </Button>
                  <Button
